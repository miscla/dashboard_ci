      ...
      <aside class="column is-2">
        <nav class="menu">
          ...
          <ul class="menu-list">
            ...
            <li><a class="is-active" href="<?php echo base_url(); ?>index.php/rute/kelebihan_bayar"><span class="icon is-small"><i class="fa fa-table"></i></span> Kelebihan Bayar</a></li>  
          </ul>
          <p class="menu-label">
            Filter Pada All Table
          </p>
          <ul class="menu-list">
          <form action="<?php echo base_url()."index.php/rute/filter_ahliwaris"; ?>" method="POST">
            <nav class="panel">
                ...
                <div class="columns">
                  <div class="column is-12">
                    <div class="field has-addons">
                      <p class="control">
                        <input class="input" type="number" placeholder="Jumlah Ahli Waris" name="ahli_waris" value="0">
                      </p>
                    </div>
                  </div>
                </div>
