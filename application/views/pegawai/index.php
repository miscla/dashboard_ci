      ...
      <main class="column">
        <div class="level">
          <div class="level-left">
            <div class="level-item">
              <div class="title">Dashboard Pegawai</div>
            </div>
          </div>
        </div>
          ...
          <div class="column is-4">
            <div class="panel">
              <div class="panel-block" style="width:100%">
                ...
                <a href="<?php echo base_url(); ?>index.php/rute/iuran_pegawai" class="button is-link" style="">Detail</a>
              </div>
              <div class="panel-block" style="width:100%;">
                <div class="columns is-multiline">
          ...
          <div class="column is-2">
            <div class="panel">
              <div class="panel-block" style="width:100%">
                ...
                <a href="<?php echo base_url(); ?>index.php/rute/sk_pegawai" class="button is-link" style="">Detail</a>
              </div>
              <div class="panel-block" style="width:100%;">
                <div id="content">
                  <div id="thermometer">
          ...
          <div class="column is-6">
            <div class="panel">
              <div class="panel-block" style="width:100%">
                ...
                ?> Bulan</font></p>
                <a href="<?php echo base_url(); ?>index.php/rute/tangguhan_pegawai" class="button is-link" style="">Detail</a>
              </div>
              <div class="panel-block" style="width:100%">
        ...
        <div class="panel">
          <div class="panel-block" style="width:100%">
            ...
            <a href="<?php echo base_url(); ?>index.php/rute/kelebihan_bayar_pegawai" class="button is-link" style="">Detail</a>
          </div>
