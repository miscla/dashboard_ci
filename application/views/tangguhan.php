        ...
        <div class="columns is-multiline">
          <div class="column" style="text-align:center">
            <div class="box notification is-primary">
              ...
              <div class="title">200 Jiwa</div>
              <div class="level">
                <div class="level-item">
                  <div class="">
                    <div class="heading">1 - 6 Bulan</div>
                    <div class="title is-5">150 Jiwa</div>
                  </div>
                </div>
                <div class="level-item">
                  <div class="">
                    <div class="heading">6 - 12 Bulan</div>
                    <div class="title is-5">50 Jiwa</div>
                  </div>
                </div>
                <div class="level-item">
                  <div class="">
          ...
          <div class="panel column is-12">
            ...
            <div class="panel-block column is-12">
              <table id="fullfeatures" class="table is-striped is-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <tr>
                    <td style="padding-top:15px;">Kimberley1</td>
                    <td style="padding-top:15px;">Pensiunan Ilang</td>
                    <td style="padding-top:15px;">Rp. 24.000</td>
                  ...
                  <tr>
                    <td style="padding-top:15px;">Kimberley2</td>
                    <td style="padding-top:15px;">Pensiunan Ilang</td>
                    <td style="padding-top:15px;">Rp. 24.000</td>
                    <td style="padding-top:15px;">February 7th, 2016</td>
                    <td style="width:200px">
